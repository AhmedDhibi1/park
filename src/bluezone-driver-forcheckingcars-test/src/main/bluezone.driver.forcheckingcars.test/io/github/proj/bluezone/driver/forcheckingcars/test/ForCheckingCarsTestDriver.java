package io.github.proj.bluezone.driver.forcheckingcars.test;
...
public class ForCheckingCarsTestDriver implements Driver {
	...
	public void run ( String... args ) {
		...
		XmlPackage xmlPackage = new XmlPackage ( "io.github.proj.bluezone.driver.forcheckingcars.test.illegallyparkedcar.*" );
